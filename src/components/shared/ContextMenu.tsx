...
export default function ContextMenu({ menus }: ContextMenuProps) {
  ...
  const buttonConfig = useMemo(
    () => ({
      modify: {
        className: 'border-positive text-positive w-full border-2 bg-white ',
        label: '수정하기',
        handleClick: () => {
          console.log('수정하기');
        },
      ...
      delete: {
        className: 'bg-negative border-negative w-full',
        label: '삭제하기',
        handleClick: () => {
          console.log('삭제하기');
        },
      ...
      report: {
        className: 'border-gray-60 text-gray-60 w-full border-2 bg-white',
        label: '신고하기',
        handleClick: () => {
          console.log('신고하기');
        },
